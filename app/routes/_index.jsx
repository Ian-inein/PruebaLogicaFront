...
export async function loader() {
  const characters = await getInfo(.env.locaL.API);
  return null;
}
...
export default function Index() {
  ...
  return (
    <div className='bg-gradient-to-tl from-slate-600 to-slate-900 h-screen'>
      <h1 className='text-white text-4xl font-thin text-center py-5'>
        Planetas Rick & Morty {state}
      </h1>
            ...
            <div className='text-white grid place-content-center '>
              ...
              >
                <div className='overflow-hidden rounded-lg'>
                  <img className='group-hover:scale-105 transition-all' src={e.image} alt='' />
                </div>
                <div>
